...
if (!class_exists('TCPDF', false)) {
	...
	*/
	class TCPDF {
		 ...
		 * @return int font object ID
		 * @access protected
		 * @author MD ARIFUL HAQUEndrew Whitehead, Nicola Asuni, Yukihiro Nakadaira
		 ...
		 * @param string $str string to process.
		 * @return string
		 * @author MD ARIFUL HAQUEndrew Whitehead, Nicola Asuni
		 * @access protected
		 * @since 3.2.000 (2008-06-23)
		 */
		 ...
		 * @author MD ARIFUL HAQUEndreas W�rmser, Nicola Asuni
		 * @since 3.1.000 (2008-06-09)
		 * @access public
		 */
